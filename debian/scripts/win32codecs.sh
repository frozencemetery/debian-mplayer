...
#this script will download binary codecs for mplayer
...
INSTALL () { 
    ...
    cd $CODECDIR/mplayer_win32_codecs
...
LINK () {
    cd $CODECDIR/
    cat $CODECDIR/mplayer_win32_codecs/$1 | while read f ; do
    ln -sbf mplayer_win32_codecs/"$f" .
    done
}
...
### FIXME  
#    cd $CODECDIR
#    cat $CODECDIR/mplayer_win32_codecs/$1 | while f do
#    ln -sbf mplayer_win32_codecs/"$f" 
#    done
